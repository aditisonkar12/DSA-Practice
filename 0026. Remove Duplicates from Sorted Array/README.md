...
### Output:
- An integer `k`, representing the number of unique elements in the array after removing duplicates.
...
The rest of the array elements beyond index `4` are ignored.
